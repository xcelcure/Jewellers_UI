...
@Component({
  selector: 'app-front-position',
  templateUrl: './front-position.component.html',
  styleUrls: ['./front-position.component.css']
})
export class FrontPositionComponent implements OnInit ,AfterViewInit {
  ngAfterViewInit() {}
