...
@Component({
  selector: 'app-metal-balance',
  templateUrl: './metal-balance.component.html',
  styleUrls: ['./metal-balance.component.css']
})
export class MetalBalanceComponent implements OnInit {
...
ngAfterViewInit() {}
    ...
    constructor(
      ...
      this.subtitle = "Metal Balance Report";
    }
    ngOnInit() {
      const date = new Date(),
        y = date.getFullYear(),
